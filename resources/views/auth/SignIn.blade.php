...
@section('content')
    <div class="w-full h-screen flex items-center justify-center">
        <form method="POST" action="{{ route("signIn_process") }}" class="w-full md:w-1/3 bg-white rounded-lg">
            @csrf
            ...
            <div class="px-12 pb-10">
                ...
                <button type="submit"
                        class="w-full py-2 rounded-full bg-green-600 text-gray-100  focus:outline-none">Войти</button>
            </div>
        </form>
    </div>
@endsection
